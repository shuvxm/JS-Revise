...
const App = () => {
  ...
  return (
    <div className='ui container'>
      <Header />
      <AddContact />
      <ContactList contacts={ contacts} />   {/*rendering list here, use props here: pass property name & pass prop which i want to pass (to render list), passed contact array */}
